...
// ScReduce32 reduces the 32-byte little-endian integer in s modulo the
// Ed25519 group order (L = 2^252 + 27742317777372353535851937790883648493).
// After this function returns, out contains the reduced scalar in canonical
// form, i.e., s is in the range [0, L-1].
//
// This routine applies a multi-pass carry propagation in 21-bit chunks to
// fold the integer back into the valid range. It is used wherever scalars
// must be guaranteed to be reduced modulo the group order for Ed25519
// operations such as signing or key generation.
